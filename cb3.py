...
with chat_container.container():
    ...
    for msg in st.session_state.messages:
        display_chat_message(msg["role"], chat_container, msg["content"], st.session_state.character_avatar_url if msg["role"] == "assistant" else user_avatar_url)
...
# 대화 진행
    ...
    if user_input:
        ...
        with chat_container.container():
            st.markdown('<div class="chat-wrapper"><div class="chat-container">', unsafe_allow_html=True)
            for msg in st.session_state.messages:
                display_chat_message(msg["role"], chat_container, msg["content"], 
